...
export const financeReconciliation: CaseBundle = {
  ...
  prompt: {
    zh: composeCasePrompt({
      role: '你是一名擅长 Windows 桌面软件的资深工程师。请帮我做一个本地运行的 Windows 桌面小工具，目标用户是电商公司的财务人员，完全不懂代码。',
...
- 附带 3 个脱敏测试样例文件：完全匹配、金额差异、重复订单 + 退款流水，方便新用户一打开就能跑通。`,
    ...
    en: composeCasePrompt({
      role: 'You are a senior engineer experienced with Windows desktop apps. Build a local Windows desktop tool for the finance team at an e-commerce company. The user is a non-developer.',
