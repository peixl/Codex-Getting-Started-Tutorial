export const zh = {
  ...
  home: {
    ...
    flowStep3Body:
      'Codex 会先用几句话确认理解，然后自己写代码、跑起来、修错误、做验证。你看到一个窗口弹出来，那就是你的第一个小工具。',
  ...
  guide: {
    ...
    sec1P3:
      '本教程只讲一件事：在你自己的 Windows 或 macOS 电脑上，做一个双击就能打开的小软件。不碰网站，不碰服务器，不碰手机 App。',
  ...
  cases: {
    ...
    after3: '让 Codex 按提示自动实现、运行和验证；最后再微调公司名、字段名、按钮文字',
  ...
  tips: {
    ...
    tip2Body:
      '让它先用 10 行以内说明目标、流程和验收标准。如果没有真正卡住的问题，就要求它继续实现、运行、修错和验证。',
    tip3Title: '给它看真实的文件',
    tip3Body:
    ...
    tip9Body:
      '动手之前说一句“先列出 3 个主要使用场景和每个场景怎么验收，然后直接实现”。你会马上看出它是否真的听懂你要什么。',
  ...
  faq: {
    ...
    q13: '第一次试完全看不懂输出，怎么办？',
    a13: '说一句「只用中文、不要代码、用五句话告诉我你接下来准备做什么；如果没有阻塞问题，就继续做完并验证」。它会马上换成人话，也不会停在只解释不动手。',
