export const zh = {
  ...
  generator: {
    ...
    recoveryEvidenceLabel: '可选：把错误/日志贴在这里',
    recoveryEvidencePlaceholder:
      '例如：终端最后 80 行、错误弹窗文字、你刚才点了什么。复制修复提示词时会一起带上。',
    recoveryEvidenceHint: '不上传，只在本页临时拼进修复提示词。',
  ...
  guide: {
    ...
    secStopItem1Title: '看到真实产物就停',
    secStopItem1Body: '软件能打开，示例数据能跑完，并导出文件，就先停止加功能。',
    secStopItem2Title: '同一个错别硬修',
    secStopItem2Body: '同一问题连续三次没修好，就让 Codex 降级或关掉边缘功能，先保住主流程。',
    secStopItem3Title: '新想法放到 v2',
    secStopItem3Body: '把“再加一个功能”写进已知限制或 v2 想法，不要把第一版拖成无限项目。',
  ...
  cases: {
    ...
    sampleFieldsHint: '复制提示词前，可以把你的 Excel / CSV 表头改成这些名字，或把真实表头一起贴给 Codex。',
    sectionPrompt: '现成提示词',
